            ...
            boost::asio::async_read(socket->mHandle,
                                    ...
                                    [&op, socket, this](const boost::system::error_code &ec, u64 bytesTransfered)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                auto msg = "The provided buffer does not fit the received message. Expected: " + std::to_string(boost::asio::buffer_size(op.mBuffs[1])) + ", actual: " + std::to_string(op.mSize);
