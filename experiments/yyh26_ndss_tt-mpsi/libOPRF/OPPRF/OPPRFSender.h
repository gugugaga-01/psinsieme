...
namespace osuCrypto
{
    ...
    public:
		...
		void sendSSTableBased(u64 IdxTheirParty, binSet& bins, std::vector<block>& plaintexts,  const std::vector<Channel*>& chls, const std::vector<u64> FourModulo, const u64 index);
		...
		void sendSSTableBased(u64 IdxP, binSet& bins, std::vector<block>& plaintexts, std::vector<std::vector<u128>> OLE_result, const std::vector<Channel*>& chls, const std::vector<u64> FourModulo, const u64 index);
		void sendSSTableBased(u64 IdxP, binSet& bins, const std::vector<Channel*>& chls);
